...
<body>
    ...
    <div class="bannerhalfvideo">
        <div class="video" data-toggle="modal" data-target="#video">
            <img src="img/avilesbanner.jpg" class="thumb" />
            <img src="img/playbutton.png" class="play" />
        </div>
        <div class="cards">
            <div class="card">
                <div class="cardimage">
                    <img src="img/prot1.jpg" style="object-position: left"/>
                </div>
                <div class="cardtext">
            ...
            <div class="card">
                <div class="cardimage">
                    <img src="img/prot2.jpg" class="fr-fil" />
                </div>
                <div class="cardtext">
            ...
            <div class="card">
                <div class="cardimage">
                    <img src="img/prot3.jpg" style="object-position:right;" />
                </div>
                <div class="cardtext">
    ...
    <div class="container-fluid avilesencima">
        <div class="container">
...
en un solo día.</h4>
    ...
    <div class="container-fluid avilesdebajo">
